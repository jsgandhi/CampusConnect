  ...
  return (
    <aside className="w-64 shrink-0 hidden md:block min-h-[calc(100vh-65px)] glass-panel border-r border-slate-800/80 p-4 space-y-6">
      ...
      <div className="pt-6 border-t border-slate-800/80">
        <Link
          href="/login"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-950/30 transition-colors"
        >
